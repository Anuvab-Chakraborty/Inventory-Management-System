...
from IMS.employee import employeeClass
from IMS.supplier import supplierClass
from IMS.category import categoryClass
from IMS.product import productClass
from IMS.sales import salesClass
...
class IMS:
    def __init__(self,root):
        ...
        #====footer====
        lbl_footer = Label(self.root,text="IMS-Inventory Management System | Developed By Anuvab",font=("times new roman", 15, "bold"), bg="#4d636d", fg="white").pack(side=BOTTOM,fill=X)
        self.update_content()
